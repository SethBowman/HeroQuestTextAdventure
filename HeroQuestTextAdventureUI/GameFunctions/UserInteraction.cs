...
public static class UserInteraction
{
    ...
    public static void PlayerDeath(string text)
    {
    ...
    public static void PlayerInquiry(string[] questions, string[] answers)
    {
        ...
        while (!validChoice)
        {
            ...
            {
                GameDialogue("I don't understand your choice. Please select a valid option.");
                GetUserInput(questionPrompt);
            }

            if (choiceIndex == questions.Length)
            {
                GameDialogue("Goodbye brave adventurer!\n");
                return;
            }
